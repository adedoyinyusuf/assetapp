...
;// CONCATENATED MODULE: ./lib/auth/roles.ts
...
(function(UserRole) {
    ...
    UserRole["SUPER_ADMIN"] = "SUPERADMIN"; // System owner with all permissions (note: no underscore to match database)
})(UserRole || (UserRole = {}));
var Resource;
(function(Resource) {
    Resource["ASSET"] = "ASSET";
    Resource["ASSET_CATEGORY"] = "ASSET_CATEGORY";
    Resource["ASSET_MOVEMENT"] = "ASSET_MOVEMENT";
    Resource["USER"] = "USER";
    Resource["ROLE"] = "ROLE";
...
(function(Task) {
    // Asset Tasks
    Task["VIEW_ASSET_DETAILS"] = "VIEW_ASSET_DETAILS";
    Task["CREATE_ASSET"] = "CREATE_ASSET";
    Task["UPDATE_ASSET"] = "UPDATE_ASSET";
    Task["DELETE_ASSET"] = "DELETE_ASSET";
    Task["APPROVE_ASSET_CREATION"] = "APPROVE_ASSET_CREATION";
    Task["AUDIT_ASSET"] = "AUDIT_ASSET";
    // Movement Tasks
    Task["VIEW_MOVEMENT_HISTORY"] = "VIEW_MOVEMENT_HISTORY";
    Task["CREATE_MOVEMENT"] = "CREATE_MOVEMENT";
    Task["APPROVE_MOVEMENT"] = "APPROVE_MOVEMENT";
    Task["CANCEL_MOVEMENT"] = "CANCEL_MOVEMENT";
    // Report Tasks
    Task["VIEW_BASIC_REPORTS"] = "VIEW_BASIC_REPORTS";
    Task["VIEW_ADVANCED_REPORTS"] = "VIEW_ADVANCED_REPORTS";
    Task["EXPORT_REPORTS"] = "EXPORT_REPORTS";
    Task["SCHEDULE_REPORTS"] = "SCHEDULE_REPORTS";
    // Analytics Tasks
    Task["VIEW_BASIC_ANALYTICS"] = "VIEW_BASIC_ANALYTICS";
    Task["VIEW_ADVANCED_ANALYTICS"] = "VIEW_ADVANCED_ANALYTICS";
    Task["EXPORT_ANALYTICS"] = "EXPORT_ANALYTICS";
    // Search Tasks
    Task["BASIC_SEARCH"] = "BASIC_SEARCH";
    Task["ADVANCED_SEARCH"] = "ADVANCED_SEARCH";
    Task["SAVE_SEARCHES"] = "SAVE_SEARCHES";
    // User Management Tasks
    Task["VIEW_USERS"] = "VIEW_USERS";
    Task["CREATE_USERS"] = "CREATE_USERS";
    Task["UPDATE_USER_ROLES"] = "UPDATE_USER_ROLES";
    Task["DEACTIVATE_USERS"] = "DEACTIVATE_USERS";
    // System Tasks
    Task["VIEW_AUDIT_LOGS"] = "VIEW_AUDIT_LOGS";
    Task["MANAGE_SYSTEM_SETTINGS"] = "MANAGE_SYSTEM_SETTINGS";
    Task["ACCESS_WEBSOCKET"] = "ACCESS_WEBSOCKET";
})(Task || (Task = {}));
...
const basePermissions = {
    ...
    ["AUDITOR"]: [
        `${"READ"}_${"ASSET"}`,
        `${"READ"}_${"ASSET_MOVEMENT"}`,
        `${"READ"}_${"REPORT"}`,
        `${"READ"}_${"DASHBOARD"}`,
        `${"EXPORT"}_${"REPORT"}`,
        `${"AUDIT"}_${"ASSET"}`,
        `${"AUDIT"}_${"ASSET_MOVEMENT"}`,
        `${"SEARCH"}_${"SEARCH"}`,
        `${"READ"}_${"ANALYTICS"}`,
        `${"EXPORT"}_${"ANALYTICS"}`,
        `${"READ"}_${"USER"}` // For audit logs
    ],
    ["OPERATOR"]: [
        `${"CREATE"}_${"ASSET"}`,
        `${"UPDATE"}_${"ASSET"}`,
        `${"CREATE"}_${"ASSET_MOVEMENT"}`,
        `${"UPDATE"}_${"ASSET_MOVEMENT"}`,
        `${"READ"}_${"ASSET"}`,
        `${"READ"}_${"REPORT"}`,
        `${"READ"}_${"DASHBOARD"}`,
        `${"SEARCH"}_${"SEARCH"}`,
    ...
    ["MANAGER"]: [
        ...
        `${"READ"}_${"ANALYTICS"}`,
        `${"READ"}_${"WEBSOCKET"}`,
        `${"APPROVE"}_${"ASSET_MOVEMENT"}`
    ],
    ["ADMIN"]: [
        `${"MANAGE"}_${"ASSET"}`,
        `${"MANAGE"}_${"ASSET_CATEGORY"}`,
        `${"MANAGE"}_${"ASSET_MOVEMENT"}`,
        `${"MANAGE"}_${"USER"}`,
        `${"MANAGE"}_${"REPORT"}`,
        `${"IMPORT"}_${"ASSET"}`,
        `${"MANAGE"}_${"ANALYTICS"}`,
...
function getAccumulatedPermissions(role) {
...
const defaultPermissions = {
    ["VIEWER"]: getAccumulatedPermissions("VIEWER"),
    ["OPERATOR"]: getAccumulatedPermissions("OPERATOR"),
    ["MANAGER"]: getAccumulatedPermissions("MANAGER"),
    ["AUDITOR"]: getAccumulatedPermissions("AUDITOR"),
    ["ADMIN"]: getAccumulatedPermissions("ADMIN"),
    ["SUPERADMIN"]: getAccumulatedPermissions("SUPERADMIN")
};
/**
 ...
 */ function hasPermission(userRole, resource, action) {
    ...
    return permissions.includes(requiredPermission) || permissions.includes(`${"MANAGE"}_${resource}`);
}
/**
 * Check if a user can perform a specific task
 */ function canPerformTask(userRole, task) {
 ...
 */ function getMinimumRoleForPermission(resource, action) {
    const requiredPermission = `${action}_${resource}`;
 ...
 */ function getMinimumRoleForTask(task) {
    for (const role of Object.values(UserRole)){
        const tasks = taskPermissions[role];
 ...
 */ function getFeatureFlags(userRole) {
    const baseFlags = [
        "basic_dashboard"
    ];
    if (canPerformTask(userRole, "VIEW_BASIC_ANALYTICS")) {
        baseFlags.push("basic_analytics");
    }
    if (canPerformTask(userRole, "VIEW_ADVANCED_ANALYTICS")) {
        baseFlags.push("advanced_analytics");
    }
    if (canPerformTask(userRole, "BASIC_SEARCH")) {
        baseFlags.push("basic_search");
    }
    if (canPerformTask(userRole, "ADVANCED_SEARCH")) {
        baseFlags.push("advanced_search");
    }
    if (canPerformTask(userRole, "ACCESS_WEBSOCKET")) {
        baseFlags.push("real_time_updates");
    }
    if (canPerformTask(userRole, "MANAGE_SYSTEM_SETTINGS")) {
...
/* harmony default export */ const middleware_0 = ((0,middleware.withAuth)(function middleware(req) {
    ...
    if (!userRole) {
        return new spec_extension_response/* NextResponse */.x("Access Denied", {
            status: 403
        });
    }
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir